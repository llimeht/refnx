...
\begin{figure}
  ...
  \caption{Corner plot for the varying parameters of DMPC bilayers measured at three contrasts. The sampling took $\sim$12 minutes for 30 saved steps, corresponding to 6000 samples, with the steps being thinned by a factor of 100.}
  \label{fig:corner}
\end{figure}
