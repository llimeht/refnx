...
\end{itemize} 
Each of these points are frequently neglected. For example, the use of different software versions may change the output of an analysis, or the use of a GUI program may not record the full set of steps, or options, applied by a user.
